...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create coding-fm-65a4
  fly apps create coding-fm-65a4-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app coding-fm-65a4
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app coding-fm-65a4-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'coding-fm-65a4-staging' does not match app name in config file 'coding-fm-65a4'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name coding-fm-65a4-db
  fly postgres attach --app coding-fm-65a4 coding-fm-65a4-db

  fly postgres create --name coding-fm-65a4-staging-db
  fly postgres attach --app coding-fm-65a4-staging coding-fm-65a4-staging-db
  ```
